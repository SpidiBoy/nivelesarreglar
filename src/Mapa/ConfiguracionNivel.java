...
public abstract class ConfiguracionNivel {
    ...
    public static class Nivel1 extends ConfiguracionNivel {
        ...
        public List<Point> getItemSpawnPoints() {
            List<Point> spawns = new ArrayList<>();
            // Puntos de spawn vacíos - los items aparecen dinámicamente
            return spawns;
        }
        ...
        public List<Point> getPosicionesLlamasEstaticas() {
            ...
            posiciones.add(new Point(122, 342));
            posiciones.add(new Point(127, 342));
            posiciones.add(new Point(199, 342));
            posiciones.add(new Point(349, 342));
            posiciones.add(new Point(355, 342));
            return posiciones;
        }
    }
    ...
    public static class Nivel2 extends ConfiguracionNivel {
        ...
        @Override
        public boolean tienePlataformasMoviles() {
            return false; // Nivel 2 NO tiene plataformas móviles
        }
        ...
        @Override
        public boolean tieneLlamasEstaticas() {
            return false; // Nivel 2 tiene fuegos móviles en su lugar
        }
